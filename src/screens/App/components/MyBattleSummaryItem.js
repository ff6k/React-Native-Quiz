...
const MyBattleSummaryItem = ({
  item: { category, sub_category, level, total_score } = {},
  index,
  theme,
}) => {
  ...
  let quizType = quizTypes[category]?.find((q) => q.value === sub_category);
...
export default MyBattleSummaryItem;
